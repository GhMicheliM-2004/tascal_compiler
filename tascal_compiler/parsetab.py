...
_lr_productions = [
  ...
  ('expressao -> expressao_simples','expressao',1,'p_expressao','parser.py',168),
  ('expressao -> expressao_simples relacao expressao_simples','expressao',3,'p_expressao','parser.py',169),
  ('expressao_simples -> termo','expressao_simples',1,'p_expressao_simples','parser.py',194),
  ('expressao_simples -> expressao_simples MAIS termo','expressao_simples',3,'p_expressao_simples','parser.py',195),
  ('expressao_simples -> expressao_simples MENOS termo','expressao_simples',3,'p_expressao_simples','parser.py',196),
  ('expressao_simples -> expressao_simples OR termo','expressao_simples',3,'p_expressao_simples','parser.py',197),
  ('termo -> fator','termo',1,'p_termo','parser.py',222),
  ('termo -> termo VEZES fator','termo',3,'p_termo','parser.py',223),
  ('termo -> termo DIV fator','termo',3,'p_termo','parser.py',224),
  ('termo -> termo AND fator','termo',3,'p_termo','parser.py',225),
  ('fator -> ID','fator',1,'p_fator','parser.py',250),
  ('fator -> NUMERO','fator',1,'p_fator','parser.py',251),
  ('fator -> TRUE','fator',1,'p_fator','parser.py',252),
  ('fator -> FALSE','fator',1,'p_fator','parser.py',253),
  ('fator -> EPAR expressao DPAR','fator',3,'p_fator','parser.py',254),
  ('fator -> NOT fator','fator',2,'p_fator','parser.py',255),
  ('fator -> MENOS fator','fator',2,'p_fator','parser.py',256),
  ('relacao -> IGUAL','relacao',1,'p_relacao','parser.py',291),
  ('relacao -> DIFERENTE','relacao',1,'p_relacao','parser.py',292),
  ('relacao -> MENORQUE','relacao',1,'p_relacao','parser.py',293),
  ('relacao -> MENORIGUAL','relacao',1,'p_relacao','parser.py',294),
  ('relacao -> MAIORQUE','relacao',1,'p_relacao','parser.py',295),
  ('relacao -> MAIORIGUAL','relacao',1,'p_relacao','parser.py',296),
